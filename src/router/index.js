...
import psychologicalTest from '@/components/patient/psychologicalTest/psychologicalTest';
  ...
  routes: [
    { path: '/internal',
      ...
      children: [
        ...
        { path: '/psychologicalTest', name: 'psychologicalTest', component: psychologicalTest },
