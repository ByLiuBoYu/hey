    ...
    <!-- 菜单开始 -->
      <div class="menu" :class="{ smallNav: isCollapse }">
        <el-menu default-active="1-4-1" class="el-menu-vertical-demo"  :collapse="isCollapse"  theme="dark">
          ...
          <el-submenu index="4" v-if="type === '01' || type === '04' || type === '07'">
            <template slot="title">
            ...
            <el-menu-item-group>
              ...
              <el-menu-item index="4-2" v-if="type !=='07'"><router-link to="registerManage">管理挂号信息</router-link></el-menu-item>
              <el-menu-item index="4-3" v-if="type !=='07'"><router-link to="takecash">缴费办理</router-link></el-menu-item>
            </el-menu-item-group>
          </el-submenu>
          ...
          <el-submenu index="7">
            ...
            <el-menu-item-group>
              ...
              <el-menu-item index="7-2" v-if="type !=='07'"><router-link to="hasPatient">查看患者列表信息</router-link></el-menu-item>
              ...
              <el-menu-item index="7-5" v-if="type === '07'"><router-link to="psychologicalTest">就医指南及心理测试</router-link></el-menu-item>
            </el-menu-item-group>
          </el-submenu>
          <el-submenu index="8">
            <template slot="title">
